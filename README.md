...
- 游客手机端 `/`：数字人主区域、景点选择、Query Understanding Gate、RAG 问答、拍照识景、路线推荐、逐站讲解入口。
...
- `domain`：`scenic_guide` / `route_planning` / `out_of_scope` / `unclear`
- `intent`：事实问答、景点介绍、路线请求、路线重规划或未知
